                ...
                <div className="flex justify-center items-top pt-10 min-h-screen bg-gray-100">
                    <div className="text-lg p-6 rounded-lg min-h-1/2 w-1/2 text-center">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-4 text-left">
                            <div>
                                <p><strong>Plans Done:</strong> {userProfile.plansdone}</p>
                                <p><strong>Plans In Progress:</strong> {userProfile.plansinprogress}</p>
                            </div>
                            <div>
                                <p><strong>Tasks Done:</strong> {userProfile.tasksdone}</p>
                                <p><strong>Tasks In Progress:</strong> {userProfile.tasksinprogress}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center mt-4 space-x-4">
                            ...
                            <a href="https://github.com" target="_blank" rel="noopener noreferrer">
                                <FaGithub className="text-gray-600 text-2xl hover:text-black" />
                            </a>
                        </div>
